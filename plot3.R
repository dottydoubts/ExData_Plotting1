...
## plot 3
png("plot3.png")
plot(dataFeb$Sub_metering_1, type = "l", xaxt = "n", xlab = "", col = "black", ylab = "Energy sub metering")
...
legend("topright", inset=.05, cex = 1, c("Sub_metering_1","Sub_metering_2", "Sub_metering_3"), horiz=FALSE, lty=c(1,1), lwd=c(2,2), col=c("black", "red","blue"))
dev.off()